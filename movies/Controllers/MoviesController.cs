...
namespace movies.Controllers
{
    public class MoviesController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> SearchMovies(string searchMovieName)
        {
            List<Movie> m = new List<Movie>();
            string apiKey = "19cad3e4cec968d8a2934e5b2ed00d7a";
            string baseUrl = "https://api.themoviedb.org/3/search/movie?query="+ searchMovieName + "&api_key="+apiKey;
